// EdgeOne Pages Node Function - MongoDB价格数据API
...
export async function onRequestGet(context) {
  console.log('Node Function被调用: /api/prices');
  ...
  try {
    ...
    console.log('请求参数:', { category, clientIp, geo });
    ...
    console.error('Node Function执行错误:', error);
    return new Response(JSON.stringify({
      success: false,
      error: '服务器内部错误',
      message: error.message,
